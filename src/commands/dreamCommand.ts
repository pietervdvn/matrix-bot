...
export default class DreamCommand extends Command<{}> {
    ...
    protected async Run(r: ResponseSender, args: { _: string }): Promise<any> {
        ...
        await r.sendElement(new Combine([d,
            "<i>This text was generated by <a href='https://www.reddit.com/user/dreamsGPT2Bot' target='_blank'>dreamsGPT2Bot</a>, which is a Machine-learning based bot active on Reddit."
        ]))
    }
